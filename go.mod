...
require (
	...
	go.opentelemetry.io/collector/pdata v0.52.1-0.20220603175357-6fb884b2dbdc // indirect
...
replace github.com/open-telemetry/opentelemetry-collector-contrib/pkg/tracer => ./pkg/tracer
