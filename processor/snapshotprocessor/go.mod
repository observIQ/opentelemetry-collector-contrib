module github.com/open-telemetry/opentelemetry-collector-contrib/processor/snapshotprocessor

go 1.21.6

require (
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/opampextension v0.97.0
