...
func convertAndDrill(entry *obsentry.Entry) pdata.LogRecord {
	return convert(entry).ResourceLogs().At(0).InstrumentationLibraryLogs().At(0).Logs().At(0)
}

func TestConvertSeverity(t *testing.T) {
	cases := []struct {
		severity       obsentry.Severity
		expectedNumber pdata.SeverityNumber
		expectedText   string
	}{
		{obsentry.Default, pdata.SeverityNumberUNDEFINED, "Undefined"},
		{5, pdata.SeverityNumberTRACE, "Trace"},
		{obsentry.Trace, pdata.SeverityNumberTRACE2, "Trace"},
		{15, pdata.SeverityNumberTRACE3, "Trace"},
		{obsentry.Debug, pdata.SeverityNumberDEBUG, "Debug"},
		{25, pdata.SeverityNumberDEBUG2, "Debug"},
		{obsentry.Info, pdata.SeverityNumberINFO, "Info"},
		{35, pdata.SeverityNumberINFO2, "Info"},
		{obsentry.Notice, pdata.SeverityNumberINFO3, "Info"},
		{45, pdata.SeverityNumberINFO3, "Info"},
		{obsentry.Warning, pdata.SeverityNumberINFO4, "Info"},
		{55, pdata.SeverityNumberINFO4, "Info"},
		{obsentry.Error, pdata.SeverityNumberERROR, "Error"},
		{65, pdata.SeverityNumberERROR2, "Error"},
		{obsentry.Critical, pdata.SeverityNumberERROR2, "Error"},
		{75, pdata.SeverityNumberERROR3, "Error"},
		{obsentry.Alert, pdata.SeverityNumberERROR3, "Error"},
		{85, pdata.SeverityNumberERROR4, "Error"},
		{obsentry.Emergency, pdata.SeverityNumberFATAL, "Error"},
		{95, pdata.SeverityNumberFATAL2, "Fatal"},
		{obsentry.Catastrophe, pdata.SeverityNumberFATAL4, "Fatal"},
	}
