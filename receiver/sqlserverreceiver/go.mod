module github.com/observIQ/opentelemetry-collector-contrib/receiver/sqlserverreceiver

go 1.17

require (
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/windowsperfcountersreceiver v0.47.1-0.20220325170833-1f1d3925aaa0
