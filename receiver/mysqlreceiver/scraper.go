...
func (m *mySQLScraper) scrape(context.Context) (pdata.ResourceMetricsSlice, error) {
	...
	for _, stat := range globalStats {
		...
		case "Innodb_buffer_pool_pages_data":
			...
			addDoubleGauge(ilm.Metrics(), metadata.M.MysqlBufferPoolPages.Name(), now, labels, parseFloat(stat.value))
		...
		case "Innodb_buffer_pool_read_ahead_rnd":
			...
			addIntSum(ilm.Metrics(), metadata.M.MysqlBufferPoolOperations.Name(), now, labels, parseInt(stat.value))
		...
		case "Com_stmt_execute":
			...
			addIntSum(ilm.Metrics(), metadata.M.MysqlCommands.Name(), now, labels, parseInt(stat.value))
		case "Com_stmt_close":
		...
		case "Handler_commit":
			...
			addIntSum(ilm.Metrics(), metadata.M.MysqlHandlers.Name(), now, labels, parseInt(stat.value))
		case "Handler_delete":
		...
		case "Innodb_dblwr_pages_written":
			...
			addIntSum(ilm.Metrics(), metadata.M.MysqlDoubleWrites.Name(), now, labels, parseInt(stat.value))
		...
		case "Innodb_log_waits":
			...
			addIntSum(ilm.Metrics(), metadata.M.MysqlLogOperations.Name(), now, labels, parseInt(stat.value))
		...
		case "Innodb_data_fsyncs":
			...
			addIntSum(ilm.Metrics(), metadata.M.MysqlOperations.Name(), now, labels, parseInt(stat.value))
		...
		case "Innodb_pages_created":
			...
			addIntSum(ilm.Metrics(), metadata.M.MysqlPageOperations.Name(), now, labels, parseInt(stat.value))
		...
		case "Innodb_row_lock_waits":
			...
			addIntSum(ilm.Metrics(), metadata.M.MysqlRowLocks.Name(), now, labels, parseInt(stat.value))
		...
		case "Innodb_rows_deleted":
			...
			addIntSum(ilm.Metrics(), metadata.M.MysqlRowOperations.Name(), now, labels, parseInt(stat.value))
		...
		case "Table_locks_immediate":
			...
			addIntSum(ilm.Metrics(), metadata.M.MysqlLocks.Name(), now, labels, parseInt(stat.value))
		...
		case "Sort_merge_passes":
			...
			addIntSum(ilm.Metrics(), metadata.M.MysqlSorts.Name(), now, labels, parseInt(stat.value))
		case "Sort_range":
		...
		case "Threads_cached":
			...
			addDoubleGauge(ilm.Metrics(), metadata.M.MysqlThreads.Name(), now, labels, parseFloat(stat.value))
