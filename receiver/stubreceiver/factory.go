...
// NewFactory creates a factory for stub receiver.
...
func createDefaultConfig() config.Receiver {
	return &Config{
		...
		// TODO instantiate a reasonable config struct
		HTTPClientSettings: confighttp.HTTPClientSettings{
			Endpoint: "http://localhost:80/todo",
...
func createMetricsReceiver(
	...
	ns := newStubScraper(params.Logger, cfg)
