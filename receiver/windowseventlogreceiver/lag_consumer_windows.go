...
func newLagTrackingConsumer(next consumer.Logs, tb *metadata.TelemetryBuilder, channel string) (*lagTrackingConsumer, error) {
	...
	err := tb.RegisterReceiverWindowseventlogLagCallback(func(_ context.Context, o metric.Float64Observer) error {
		...
		// collection, this reports 0, signalling the receiver is caught up.
